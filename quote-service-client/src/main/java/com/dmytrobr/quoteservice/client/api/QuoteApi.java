...
public class QuoteApi {
    ...
    /* Build call for quoteTransaction */
    private com.squareup.okhttp.Call quoteTransactionCall(QuoteRequest quote, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = quote;
        
        // verify the required parameter 'quote' is set
        if (quote == null) {
            throw new ApiException("Missing the required parameter 'quote' when calling quoteTransaction(Async)");
        }
     ...
     */
    public QuoteResponse quoteTransaction(QuoteRequest quote) throws ApiException {
        ApiResponse<QuoteResponse> resp = quoteTransactionWithHttpInfo(quote);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<QuoteResponse> quoteTransactionWithHttpInfo(QuoteRequest quote) throws ApiException {
        com.squareup.okhttp.Call call = quoteTransactionCall(quote, null, null);
     ...
     */
    public com.squareup.okhttp.Call quoteTransactionAsync(QuoteRequest quote, final ApiCallback<QuoteResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = quoteTransactionCall(quote, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<QuoteResponse>(){}.getType();
